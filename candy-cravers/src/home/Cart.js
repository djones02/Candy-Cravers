                ...
                >
                  ...
                  <div className="cart-body">
                    ...
                    <div style={{ display: "flex" }}>
                      <h3 className="cart-item" style={{ marginRight: "20px" }}>
                        Amount:
                      </h3>
                      <input
                        ...
                        type="number"
                        value={candy.amount}
                        onChange={(e) => onAmountChange(e, candy)}
                        min={"1"}
                      />
                    </div>
          ...
          >
            ...
            >
              <h3 className="cart-total">
                SubTotal Amount: ${subTotalPrice.toFixed(2)}
              </h3>
              <h3 className="cart-total">Tax: ${tax.toFixed(2)}</h3>
              <h1 className="cart-total" id="cart-total">
            ...
            <button
              ...
              style={{ boxShadow: "5px 5px 10px #1f2937" }}
